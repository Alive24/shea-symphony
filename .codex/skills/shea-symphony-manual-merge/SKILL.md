...
Live Shea Symphony merge work still runs through the protected 2606 MVP runtime
...
```bash
cargo run -- merge loop workflows/shea-symphony.md --max-iterations 1 --max-concurrent 2 --write
```
