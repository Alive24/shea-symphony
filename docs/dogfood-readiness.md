...
8. Observability.
   ...
   - `doctor` / `audit-project` is available as a project/workflow/runtime
     ...
     writing a Doctor timeline comment. `doctor --auto-fix --write` is limited to clearly
