...
Normal dogfood should exercise `project-state`, `doctor`, `run-loop`,
`review-loop`, `merge-loop`, `debug`, and related lane preflight surfaces
directly.
