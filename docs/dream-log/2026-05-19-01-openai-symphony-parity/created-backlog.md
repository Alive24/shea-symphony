...
- URL: https://github.com/Alive24/jade-symphony/issues/321
- Why it exists: OpenAI Symphony treats Codex app-server continuation,
  ...
  core orchestration loop. Jade has partial event-normalizer and subprocess
...
- URL: https://github.com/Alive24/jade-symphony/issues/322
- Why it exists: the Elixir reference can execute `linear_graphql` as a dynamic
  tool, while Jade currently describes planned tools without execution or
...
- URL: https://github.com/Alive24/jade-symphony/issues/323
- Why it exists: the spec requires invalid reloads to preserve the last known
  good workflow; Jade has helper semantics but not long-running runtime wiring
