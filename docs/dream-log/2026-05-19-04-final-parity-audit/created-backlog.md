...
- URL: https://github.com/Alive24/shea-symphony/issues/327
- Why it exists: Shea has runtime state models and session registry evidence,
  but no seed owned transition-level persistence and resume/recovery semantics.
- Dream confidence: Medium.
