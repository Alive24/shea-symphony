...
pub(crate) fn current_gmt_timestamp() -> String {
...
pub(crate) fn format_gmt_timestamp(seconds_since_unix_epoch: u64) -> String {
...
#[cfg(test)]
mod tests {
    use super::format_gmt_timestamp;

    #[test]
    fn formats_unix_epoch_as_gmt() {
